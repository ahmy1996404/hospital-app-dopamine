            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title"> Patients &nbsp;
                        <a href="{{ route('admin.patient.create') }}" class="btn btn-success">Create patient</a>
                    </h3>
                </div>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu custom" role="menu">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.patient.show', $row->id) }}"> <span
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.patient.edit', $row->id) }}"> <span
