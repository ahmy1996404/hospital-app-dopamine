...
<html lang="en">
  <head>
    ...
    <title>Admin {{ \App\Helpers\Utility::getValByName('title_text') }} </title>
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> {{ \App\Helpers\Utility::getValByName('title_text') }} </a></div>
    ...
    <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        <a class="breadcrumb-item" href="index.html">Dopamine</a>
