                            ...
                            @foreach ($data as $row)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu custom" role="menu">
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.article.show', $row->id) }}"> <span
                                                        aria-hidden="true" class="fas fa-eye"
                                                        style="color: #4ecdf0;"></span> Show</a>
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.article.edit', $row->id) }}"> <span
                                        ...
                                        {!! Form::open(['url' => route('admin.article.destroy', $row->id), 'method' => 'DELETE', 'class' => 'form-horizontal', 'id' => 'form_' . $row->id]) !!}
