        ...
        <div class="left">
            ...
            <div class="top">
                ...
                <div class="tub">
                    <ul class="navbar-nav m-auto">
                        <a class="nav-item" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">

                            <span class="avatar">

                                <span class="avatar-status-online"> Select doctor</span>
                            </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                            ...
                            @foreach ($doctors as $doctor)
                                <a class="dropdown-item"
                                    href="{{ route('patient.chat.index', ['id' => $doctor->id]) }}">{{ $doctor->name }}</a>
                            @endforeach
            ...
            <div class="conversations">
                @foreach ($doctorChat as $doctor)
                    <a class="person" href="{{ route('patient.chat.index', ['id' => $doctor->doctor_id]) }}">

                        <div class="box">
                            <div class="image">
                                @if ($doctor->avatar != null)
                                    <img src="{{ asset('/upload/doctor/' . $doctor->avatar) }}" height="50px"
                                        width="50px">
                                @else
                    ...
                    <div class="box">
                        ...
                        <div class="image">
                            @if ($chatWith->profile_photo_path != null)
                                <img src="{{ asset('/upload/doctor/' . $chatWith->profile_photo_path) }}" height="35px"
                                    width="35px">
                            @else
