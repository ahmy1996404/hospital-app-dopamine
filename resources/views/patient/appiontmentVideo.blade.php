                ...
                <div class="col-lg-12">
                    <div class="appointment-widget-form">
                        <div class="appointment-from">
                            <h2>Get Your Video Appointment</h2>
                            <p>Online Easily During This Corona Pandemic</p>
                            {!! Form::open(['route' => 'patient.video.appointment.store', 'files' => true, 'method' => 'post']) !!}
                            @if (!$doctor)
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group date" id="">
                                                ...
                                                <select id="avail-dd" class="form-control" name="date">
                                                    ...
                                                    @foreach ($doctors->workingHoursVideo as $available)
        ...
        $(document).ready(function() {
            ...
            $('#doctor_id_dd').on('change', function() {
                ...
                $.ajax({
                    ...
                    url: "{{ url('api/doctor/video-working-hours') }}",
                    type: "POST",
                    data: {
                        doctor_id: idDoctor,
                        _token: '{{ csrf_token() }}'
